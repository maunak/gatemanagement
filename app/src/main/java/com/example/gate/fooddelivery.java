...
public class fooddelivery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fooddelivery);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(name)) {
                    nameEdt.setError("Please enter Agent's Name");
                } else if (TextUtils.isEmpty(phoneNumber)) {
                    phoneNumberEdt.setError("Please enter Phone Number");
                } else if (TextUtils.isEmpty(detail)) {
                    detailEdt.setError("Please enter Delivery Company ");
                }else if (TextUtils.isEmpty(vehicleNumber)) {
                    vehicleNumberEdt.setError("Please enter Vehicle Number  ");
    ...
    private void addDataToFirestore(String name, String phoneNumber, String detail, String vehicleNumber,String block,String entryTime) {
        ...
        dbEntry.add(entryData).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                ...
                Toast.makeText(fooddelivery.this, "Your FoodDelivery's Entry has been added successfully", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(fooddelivery.this, "Fail to add entry \n" + e, Toast.LENGTH_SHORT).show();
            }
        });
